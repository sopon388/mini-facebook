...
export default function Friends() {
  ...
  const loadUsers = async () => {
    ...
    const res = await axios.get(
      'https://mini-facebook-1.onrender.com/api/auth/users'
    );
  ...
  const loadRequests = async () => {
    ...
    const res = await axios.get(
      `https://mini-facebook-1.onrender.com/api/friends/notifications/${me._id}`
    );
  ...
  const sendRequest = async (id) => {
    ...
    try {
      ...
      const res = await axios.post(
        'https://mini-facebook-1.onrender.com/api/friends/send',
        {
          from: me._id,
          to: id
        }
  ...
  const acceptRequest = async (reqId) => {
    ...
    await axios.post(
      'https://mini-facebook-1.onrender.com/api/friends/accept',
      {
        id: reqId
      }
    );
  ...
  const removeFriend = async (id) => {
    ...
    await axios.post(
      'https://mini-facebook-1.onrender.com/api/friends/remove',
      {
        from: me._id,
        to: id
      }
